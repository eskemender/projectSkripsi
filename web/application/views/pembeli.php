												...
												<tbody>
													...
													foreach($semua_pembeli as $row)
													{
														...
														<tr>
															<td><?php echo $no; ?></td>
															<td>
																<a href="admin/ubah-pembeli/<?php echo $id_pembeli; ?>" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="Lihat">
																	<?php echo set_data($nama_user); ?>
																</a>
															</td>
															<td><?php echo set_data($no_telfon); ?></td>
															<td><?php echo set_data($email); ?></td>
															<td><?php echo set_data($lokasi); ?></td>
															<td>
																<a href="admin/delete-pembeli/<?php echo $id_pembeli; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill">
