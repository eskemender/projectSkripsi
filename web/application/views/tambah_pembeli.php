							...
							<div class="m-portlet__body">
								<div class="tab-content">
									<div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
										<form class="m-form m-form--fit m-form--label-align-right" id="tambahPembeli">
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Nama pembeli</label>
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="nama_pembeli" placeholder="nama pembeli">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="username" placeholder="username">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="email" placeholder="email">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="alamat" placeholder="alamat">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="telfon" placeholder="nomor telfon">
