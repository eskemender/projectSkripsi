    ...
    <div class="m-container m-container--fluid m-container--full-height">
        <div class="m-stack m-stack--ver m-stack--desktop cs-BC">
                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="" class="m-brand__logo-wrapper">
                            <img alt="" class="head-logo" src="<?php echo IMAGES_PATH; ?>logo/head-logo.png" />
                        </a>
                    </div>
            ...
            <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
                ...
                <?php if($this->session->ul_auth === 'Penjual') { ?>
                                            ...
                                            <li class="m-menu__item">
                                                ...
                                                <ul class="m-menu__inner">
                                                    <li class="m-menu__item" m-menu-link-redirect="1" aria-haspopup="true">
                                                        <a href="admin/tambah-pembeli" class="m-menu__link">
                                                            <i class="m-menu__link-icon fa fa-plus"></i>
                                                            <span class="m-menu__link-text">Tambah pembeli</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
